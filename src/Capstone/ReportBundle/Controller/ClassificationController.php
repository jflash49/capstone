...
use Capstone\ReportBundle\Entity\Classification;
use Capstone\ReportBundle\Form\ClassificationType;
...
class ClassificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ReportBundle:Classification')->findAll();

        return $this->render('ReportBundle:Classification:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ReportBundle:Classification:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ReportBundle:Classification')->find($id);
        ...
        return $this->render('ReportBundle:Classification:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ReportBundle:Classification:edit.html.twig', array(
            'entity'      => $entity,

...
use Capstone\ReportBundle\Entity\Questiontype;
use Capstone\ReportBundle\Form\QuestiontypeType;
...
class QuestiontypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ReportBundle:Questiontype')->findAll();

        return $this->render('ReportBundle:Questiontype:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ReportBundle:Questiontype:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ReportBundle:Questiontype')->find($id);
        ...
        return $this->render('ReportBundle:Questiontype:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ReportBundle:Questiontype:edit.html.twig', array(
            'entity'      => $entity,

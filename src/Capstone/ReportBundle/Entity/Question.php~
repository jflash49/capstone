...
class Question
{
    ...
    /**
     * @var \Capstone\ReportBundle\Entity\Questiontype
     *
     * @ORM\ManyToOne(targetEntity="Capstone\ReportBundle\Entity\Questiontype")
     * @ORM\JoinColumns({
     ...
     * Set questionType
     *
     * @param \Capstone\ReportBundle\Entity\Questiontype $questionType
     * @return Question
     */
    public function setQuestionType(\Capstone\ReportBundle\Entity\Questiontype $questionType = null)
    {
     ...
     * Get questionType
     *
     * @return \Capstone\ReportBundle\Entity\Questiontype 
     */

...
class School
{
    ...
    /**
     * @var \Capstone\ReportBundle\Entity\Parish
     *
     * @ORM\ManyToOne(targetEntity="Capstone\ReportBundle\Entity\Parish")
     * @ORM\JoinColumns({
     ...
     * Set parish
     *
     * @param \Capstone\ReportBundle\Entity\Parish $parish
     * @return School
     */
    public function setParish(\Capstone\ReportBundle\Entity\Parish $parish = null)
    {
        $this->parish = $parish;
     ...
     * Get parish
     *
     * @return \Capstone\ReportBundle\Entity\Parish 
     */

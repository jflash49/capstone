...
use Capstone\SetupBundle\Entity\School;
use Capstone\SetupBundle\Form\SchoolType;
...
class SchoolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SetupBundle:School')->findAll();

        return $this->render('SetupBundle:School:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SetupBundle:School:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SetupBundle:School')->find($id);
        ...
        return $this->render('SetupBundle:School:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SetupBundle:School:edit.html.twig', array(
            'entity'      => $entity,

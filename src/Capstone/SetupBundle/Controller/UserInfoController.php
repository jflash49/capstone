...
use Capstone\SetupBundle\Entity\UserInfo;
use Capstone\SetupBundle\Form\UserInfoType;
...
class UserInfoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SetupBundle:UserInfo')->findAll();

        return $this->render('SetupBundle:UserInfo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SetupBundle:UserInfo:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SetupBundle:UserInfo')->find($id);
        ...
        return $this->render('SetupBundle:UserInfo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SetupBundle:UserInfo:edit.html.twig', array(
            'entity'      => $entity,

...
class QuizController extends Controller
{
  ...
  /**
    ...
    * 
    */ 
    public function endAction($response, $quest){
      
	    return $this->render('QuizBundle::quiz.html.twig',array('end'=> $response, 'question'=>$quest));  
      }
   ...
   return $this->endAction("Quiz complete",$questionobj[0]);
    }
    /**
